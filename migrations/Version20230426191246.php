 ...
 */
final class Version20230426191246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plats (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(50) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, description VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
